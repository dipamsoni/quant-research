...
1. Verify all acceptance criteria in `docs/phases/phase-<N>.md` pass
2. Tag the repo: `git tag phase-<N>-complete`
3. Update this file: change `Active phase` to the next number
4. Read `docs/phases/phase-<N+1>.md` before writing any code for the new phase
...
| 7 | Portfolio Optimization | pending |
| 8 | RL Trading Systems | pending |
| 9 | Multi-Agent Hedge Fund | pending |
| 10 | Institutional Analytics | pending |
| 11 | Production Scaling | pending |
| 12 | Enterprise Stabilization | pending |
